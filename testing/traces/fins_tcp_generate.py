...
# Omron FINS commands
#commands = {
#    'RUN': (b'\x04\x01\x00\x00', b'\xC0\x01\x00\x00'),  # Example response
#    'STOP': (b'\x04\x02\x00\x00', b'\xC0\x02\x00\x00'),  # Example response
#    'CLOCK READ': (b'\x06\x01\x00\x00', b'\xC0\x01\x21\x12\x01\x10\x00\x00'),  # Example response with timestamp
#    'CLOCK WRITE': (b'\x06\x02\x00\x00' + struct.pack(">BBBBBB", 0x21, 0x12, 0x01, 0x10, 0x00, 0x00), b'\xC0\x02\x00\x00'),  # Example response
#    'CONTROLLER DATA READ': (b'\x05\x01\x00\x00', b'\xC0\x01\x00\x00')  # Example response
#}
...
commands = {
    ...
    'CONTROLLER DATA READ 1': (b'\x80\x00\x02\x00\xc8\x00\x00\x00\xef\x05\x05\x01\x00',         b''),
    'CONTROLLER DATA READ 2': (b'\x80\x00\x02\x00\xc8\x00\x00\x00\xef\x05\x05\x01\x00',         b''),
}
