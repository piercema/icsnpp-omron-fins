...
# Omron FINS commands
commands = {
    'RUN':  (b'\x80\x00\x02\x00\x00\x00\x00\x00\x00\x7a\x04\x01\x00\x00\x01', b'\xC1\x00\x02\x00\x00\x00\x00\x00\x00\x7a\x04\x01\x00\x00'),  # Example response
    'STOP': (b'\x80\x00\x02\x00\x00\x00\x00\x00\x00\x7a\x04\x02',             b'\xC1\x00\x02\x00\x00\x00\x00\x00\x00\x7a\x04\x02\x00\x00')   # Example response
}
