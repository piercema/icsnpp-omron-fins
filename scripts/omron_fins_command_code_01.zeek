module OMRON_FINS;
    ...
    function process_memory_area_read_detail(c: connection, finsCommand: OMRON_FINS::Command, link_id: string): string {
    ...
    function process_memory_area_write_detail(c: connection, finsCommand: OMRON_FINS::Command, link_id: string): string {
        # Local string to hold the response code for general logging
        local general_log_response_code : string;
        general_log_response_code = "";
    ...
    function process_multiple_memory_area_read_detail(c : connection, finsCommand: OMRON_FINS::Command, link_id: string): string {
        # Local string to hold the response code for general logging
        local general_log_response_code : string;
        general_log_response_code = "";
        ...
        if (finsCommand$icfDataType == OMRON_FINS_ENUMS::DataType_COMMAND) {
            ...
            general_log_response_code = OMRON_FINS_ENUMS::RESPONSE_CODE[finsCommand$multipleMemoryAreaReadCommand$response$responseCode];
    ...
    function process_memory_area_fill_detail(c: connection, finsCommand: OMRON_FINS::Command, link_id: string): string {
        # Local string to hold the response code for general logging
        local general_log_response_code : string;
        general_log_response_code = "";
    ...
    function process_memory_area_transfer_detail(c: connection, finsCommand: OMRON_FINS::Command, link_id: string): string {
        # Local string to hold the response code for general logging
        local general_log_response_code : string;
        general_log_response_code = "";
