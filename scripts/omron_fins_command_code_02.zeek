module OMRON_FINS;
    ...
    function process_data_link_table_write_detail(c: connection, finsCommand: OMRON_FINS::Command, link_id: string) {
        ...
        if (finsCommand$icfDataType == OMRON_FINS_ENUMS::DataType_COMMAND) {
            ...
            for (i in finsCommand$dataLinkTableWrite$command$blockRecord) {
                # Set/add the detail_log to the connection
                c = set_session_detail_log(c);
                info_detail_log = c$omron_fins_detail_log;
                ...
                info_detail_log$fixed = finsCommand$dataLinkTableWrite$command$fixed;
                info_detail_log$intelligent_id_no = finsCommand$dataLinkTableWrite$command$intelligentIdNo;
                info_detail_log$first_word = finsCommand$dataLinkTableWrite$command$firstWord;
                info_detail_log$data_length = finsCommand$dataLinkTableWrite$command$dataLength;
                info_detail_log$num_of_link_nodes = finsCommand$dataLinkTableWrite$command$numOfLinkNodesMask$numOfLinkNodes;

                info_detail_log$block_record_node_num = finsCommand$dataLinkTableWrite$command$blockRecord[i]$nodeNumMask$nodeNum;
                info_detail_log$block_record_cio_area_first_word = finsCommand$dataLinkTableWrite$command$blockRecord[i]$cioAreaFirstWord;
                info_detail_log$block_record_kind_of_dm = finsCommand$dataLinkTableWrite$command$blockRecord[i]$kindOfDM;
                info_detail_log$block_record_dm_area_first_word = finsCommand$dataLinkTableWrite$command$blockRecord[i]$dmAreaFirstWord;
                info_detail_log$block_record_num_of_total_words = finsCommand$dataLinkTableWrite$command$blockRecord[i]$numOfTotalWords;
            ...
            info_detail_log$omron_fins_link_id = link_id;
            info_detail_log = process_command_and_datatype_detail(info_detail_log, finsCommand);
            info_detail_log$response_code = OMRON_FINS_ENUMS::RESPONSE_CODE[finsCommand$dataLinkTableWrite$response$responseCode];
